...
export default function Chip(props: IChip) {
    ...
    if (!!props.style) {
        return (
            <div title={"(Click to edit) " + props.title} className="relative  animate-popOut pl-3 pr-2 py-1 h-max border border-grey-400 hover:border-grey-400 bg-neutral-200/50 rounded-full flex items-center justify-between gap-2" >
