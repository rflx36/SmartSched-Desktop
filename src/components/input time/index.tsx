...
interface ITimeInput {
    options: Array<ITimeOptions>,
    value?: ITimeOptions | undefined,
    label?: string,
    onChange: (value: ITimeOptions | undefined) => void,
    useOnly?: "AM" | "PM"
}

export default function InputTime(props: ITimeInput) {
    const [isOpen, setIsOpen] = useState(false);
   
    const selectOption = (option: ITimeOptions) => {
